...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(g=> new{ DeptNo = g.Key, AvgSal = g.Average(s => s.Sal)}).ToList(); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(em=> em.DeptNo == e.DeptNo).Select(e=> e.Sal).Average()).Select(e => e.EName).ToList(); 
